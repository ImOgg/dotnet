...
public class AppUser
{
    ...
    public required string DisplayName { get; set; } // 顯示名稱（前端展示用）
    public required string Email { get; set; } // 登入帳號
    ...
    public required byte[] PasswordHash { get; set; } // 密碼雜湊
    public required byte[] PasswordSalt { get; set; } // 雜湊用的鹽（HMAC Key）
